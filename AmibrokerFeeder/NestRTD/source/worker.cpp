...
Worker::Worker(){
	...
	Event_RTD_Update = CreateEvent( NULL, false, TRUE, NULL );				// Manual Reset = false - Event resets to nonsignaled on 1 wait release																
	...
	rtd_client = new RTDClient( settings.rtd_server_prog_id , Event_RTD_Update );
